  ...
  return (
    <div className="relative overflow-hidden min-h-[80vh]">
      <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="font-display text-4xl font-extrabold text-gray-900 md:text-5xl text-center mb-12">
          About <span className="bg-hotel-gold hover:bg-hotel-goldHover bg-clip-text text-transparent">HeavenHub</span>
        </h1>
        
        <div className="space-y-12">
          <section className="rounded-3xl border border-stone-200 bg-stone-50 border border-stone-200/80 p-6 md:p-10 shadow-xl backdrop-blur-md">
            <h2 className="text-2xl font-bold text-hotel-gold mb-4">Our Purpose</h2>
          ...
          <section className="rounded-3xl border border-stone-200 bg-stone-50 border border-stone-200/80 p-6 md:p-10 shadow-xl backdrop-blur-md">
            <h2 className="text-2xl font-bold text-amber-700 mb-4">Our Vision & Mission</h2>
            <p className="text-stone-600 leading-relaxed">
          ...
          <section className="rounded-3xl border border-stone-200 bg-stone-50 border border-stone-200/80 p-6 md:p-10 shadow-xl backdrop-blur-md">
            <h2 className="text-2xl font-bold text-emerald-700 mb-4">Who Is HeavenHub For?</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-stone-900 mb-2">For Guests</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-stone-900 mb-2">For Hosts</h3>
                <p className="text-stone-500 text-sm leading-relaxed">
